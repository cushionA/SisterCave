...
public class MagicController : MonoBehaviour, IEnhancedScrollerDelegate
{
    ...
    [SerializeField] private MagicCellView MagicCellViewPrefab;
    private List<MagicData> data;
    ...
    {
        var cellView = scroller.GetCellView(this.MagicCellViewPrefab) as MagicCellView;
    ...
    private void UpdateNavigationConnections()
    {
        ...
        var cells = this.content.Cast<RectTransform>()
            .Select(t => t.GetComponent<MagicCellView>())
