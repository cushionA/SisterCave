...
public class KeyController : MonoBehaviour, IEnhancedScrollerDelegate
{
    ...
    [SerializeField] private KeyCellView KeyCellViewPrefab;
    ...
    {
        var cellView = scroller.GetCellView(this.KeyCellViewPrefab) as KeyCellView;
    ...
    private void UpdateNavigationConnections()
    {
        ...
        var cells = this.content.Cast<RectTransform>()
            .Select(t => t.GetComponent<KeyCellView>())
