...
public class CoreCellView : EnhancedScrollerCellView
{
    //[SerializeField] private Text[] contentTexts;
    [SerializeField] private Image[] contentIcon;
    [HideInInspector] public CoreButton[] ub;
    ...
    private void Awake()
    {
        ...
        ub = this.contentIcon.Select(text => text.GetComponentInParent<CoreButton>()).ToArray();
    }
}