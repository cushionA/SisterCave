...
public class CoreController : MonoBehaviour, IEnhancedScrollerDelegate
{
    ...
    [SerializeField] private CoreCellView EquipCellViewPrefab;
    private List<CoreData> data;
    ...
    {
        var cellView = scroller.GetCellView(this.EquipCellViewPrefab) as CoreCellView;
