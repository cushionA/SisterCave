...
public class EnemyCellView : EnhancedScrollerCellView
{
    //[SerializeField] private Text[] contentTexts;
    [SerializeField] private Image[] contentIcon;
    [HideInInspector] public LibraryButton[] ub;
    ...
    private void Awake()
    {
        ...
        ub = this.contentIcon.Select(text => text.GetComponentInParent<LibraryButton>()).ToArray();
    }
}